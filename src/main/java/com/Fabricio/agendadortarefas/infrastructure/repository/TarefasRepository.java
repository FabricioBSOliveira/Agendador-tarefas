package com.Fabricio.agendadortarefas.infrastructure.repository;
...
public interface TarefasRepository extends MongoRepository<TarefasEntity, String> {
    ...
    List<TarefasEntity> findByDataEventoBetweenAndStatusNotificaoEnum(LocalDateTime dataInicial,
